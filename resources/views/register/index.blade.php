                    ...
                    <div id="login">
                        ...
                        <form class="form-horizontal" id="regform" name="regform" action="/register" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9"><input type="text" class=" form-control"  placeholder="请输入手机号码" datatype="m" nullmsg="请输入手机号码" sucmsg=" " id="txtMobile"  name="txtMobile" ajaxurl="/register/validate_mobile">
                                <span class="Validform_checktip"></span></div>
                            </div>
                            <div class="form-group">
                                <label  class="col-sm-3 control-label">验证码</label>
                                <div class="col-sm-9">
                                    <div class="col-sm-5">  <input type="text" class="form-control" id="txtCode" name="txtCode" sucmsg=" " placeholder="输入验证码"></div>
                                    <div class="col-sm-7"><a class="btn_1 medium" href="javascript:;" onclick="sendSMS(this,'#txtMobile','/register/sendsms');" id="btnSendcode">发送验证码</a></div>
                                </div>
                            </div>
                            <div class="form-group">
...
@endsection
    ...
    <script>
        $(function() {
            AjaxInitForm('#regform', '#btnSubmit', 1);
        });
    </script>
    @endpush
    @push('style')
